...
export const env = {
  ...
  ops: {
    ...
    safeToRenewCheckEnabled: process.env.SAFE_TO_RENEW_SELF_CHECK_ENABLED !== 'false',
    safeToRenewCheckIntervalMs: num(process.env.SAFE_TO_RENEW_SELF_CHECK_INTERVAL_MS, 24 * 60 * 60 * 1000),
    ...
    retentionCommandLeaseMaintenanceEnabled: bool(process.env.RETENTION_COMMAND_LEASE_MAINTENANCE_ENABLED),
    retentionCommandLeaseMaintenanceIntervalMs: num(process.env.RETENTION_COMMAND_LEASE_MAINTENANCE_INTERVAL_MS, 15 * 60 * 1000),
