...
var _Supermemory_instances, _a, _Supermemory_encoder, _Supermemory_baseURLOverridden;
...
const memories_1 = require("./resources/memories.js");
const search_1 = require("./resources/search.js");
const settings_1 = require("./resources/settings.js");
...
class Supermemory {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('SUPERMEMORY_BASE_URL'), apiKey = (0, env_1.readEnv)('SUPERMEMORY_API_KEY'), ...opts } = {}) {
        _Supermemory_instances.add(this);
        _Supermemory_encoder.set(this, void 0);
        this.memories = new API.Memories(this);
        this.documents = new API.Documents(this);
        this.search = new API.Search(this);
        this.settings = new API.Settings(this);
        this.connections = new API.Connections(this);
        if (apiKey === undefined) {
            throw new Errors.SupermemoryError("The SUPERMEMORY_API_KEY environment variable is missing or empty; either provide it, or instantiate the Supermemory client with an apiKey option, like new Supermemory({ apiKey: 'My API Key' }).");
        }
        const options = {
            apiKey,
            ...opts,
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('SUPERMEMORY_LOG'), "process.env['SUPERMEMORY_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _Supermemory_encoder, Opts.FallbackEncoder, "f");
    ...
    stringifyQuery(query) {
        return Object.entries(query)
            ...
            throw new Errors.SupermemoryError(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
        })
            .join('&');
    }
    getUserAgent() {
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _Supermemory_instances, "m", _Supermemory_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Supermemory_encoder, "f").call(this, { body, headers });
        }
    }
}
...
Supermemory.DEFAULT_TIMEOUT = 60000; // 1 minute
Supermemory.SupermemoryError = Errors.SupermemoryError;
Supermemory.APIError = Errors.APIError;
Supermemory.APIConnectionError = Errors.APIConnectionError;
Supermemory.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
Supermemory.APIUserAbortError = Errors.APIUserAbortError;
Supermemory.NotFoundError = Errors.NotFoundError;
Supermemory.ConflictError = Errors.ConflictError;
Supermemory.RateLimitError = Errors.RateLimitError;
Supermemory.BadRequestError = Errors.BadRequestError;
Supermemory.AuthenticationError = Errors.AuthenticationError;
Supermemory.InternalServerError = Errors.InternalServerError;
Supermemory.PermissionDeniedError = Errors.PermissionDeniedError;
Supermemory.UnprocessableEntityError = Errors.UnprocessableEntityError;
Supermemory.toFile = Uploads.toFile;
Supermemory.Memories = memories_1.Memories;
Supermemory.Documents = documents_1.Documents;
Supermemory.Search = search_1.Search;
Supermemory.Settings = settings_1.Settings;
Supermemory.Connections = connections_1.Connections;
