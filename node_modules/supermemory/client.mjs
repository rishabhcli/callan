...
import { Memories, } from "./resources/memories.mjs";
import { Search, } from "./resources/search.mjs";
import { Settings, } from "./resources/settings.mjs";
...
export class Supermemory {
    ...
    constructor({ baseURL = readEnv('SUPERMEMORY_BASE_URL'), apiKey = readEnv('SUPERMEMORY_API_KEY'), ...opts } = {}) {
        ...
        __classPrivateFieldSet(this, _Supermemory_encoder, Opts.FallbackEncoder, "f");
