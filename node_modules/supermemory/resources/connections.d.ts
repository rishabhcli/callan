...
export declare class Connections extends APIResource {
     ...
     * ```
     */
    create(provider: 'notion' | 'google-drive' | 'onedrive' | 'github' | 'web-crawler', body?: ConnectionCreateParams | null | undefined, options?: RequestOptions): APIPromise<ConnectionCreateResponse>;
    /**
     ...
     * ```
     */
    deleteByProvider(provider: 'notion' | 'google-drive' | 'onedrive' | 'github' | 'web-crawler', body: ConnectionDeleteByProviderParams, options?: RequestOptions): APIPromise<ConnectionDeleteByProviderResponse>;
    /**
     ...
     * ```
     */
    getByTag(provider: 'notion' | 'google-drive' | 'onedrive' | 'github' | 'web-crawler', body: ConnectionGetByTagParams, options?: RequestOptions): APIPromise<ConnectionGetByTagResponse>;
    /**
     ...
     * ```
     */
    import(provider: 'notion' | 'google-drive' | 'onedrive' | 'github' | 'web-crawler', body?: ConnectionImportParams | null | undefined, options?: RequestOptions): APIPromise<string>;
    /**
     ...
     * ```
     */
    listDocuments(provider: 'notion' | 'google-drive' | 'onedrive' | 'github' | 'web-crawler', body?: ConnectionListDocumentsParams | null | undefined, options?: RequestOptions): APIPromise<ConnectionListDocumentsResponse>;
    /**
