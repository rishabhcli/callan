...
export declare class Memories extends APIResource {
     ...
     * ```
     */
    update(id: string, body?: MemoryUpdateParams | null | undefined, options?: RequestOptions): APIPromise<MemoryUpdateResponse>;
    /**
     ...
     * ```
     */
    list(body?: MemoryListParams | null | undefined, options?: RequestOptions): APIPromise<MemoryListResponse>;
    /**
...
export declare namespace MemoryListResponse {
    interface Memory {
         ...
         */
        type: 'text' | 'pdf' | 'tweet' | 'google_doc' | 'google_slide' | 'google_sheet' | 'image' | 'video' | 'notion_doc' | 'webpage' | 'onedrive' | 'github_markdown';
        /**
...
export declare namespace MemoryListParams {
    interface Or {
        /**
