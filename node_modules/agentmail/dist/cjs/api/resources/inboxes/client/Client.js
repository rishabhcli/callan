...
const Client_js_1 = require("../resources/threads/client/Client.js");
...
class Inboxes {
    ...
    get threads() {
        var _a;
        return ((_a = this._threads) !== null && _a !== void 0 ? _a : (this._threads = new Client_js_1.Threads(this._options)));
    }
    get messages() {
        var _a;
    ...
    get metrics() {
        var _a;
        return ((_a = this._metrics) !== null && _a !== void 0 ? _a : (this._metrics = new Client_js_4.Metrics(this._options)));
    }
    /**
