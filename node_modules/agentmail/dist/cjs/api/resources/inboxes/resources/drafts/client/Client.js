    ...
    __create(inboxId, request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.AgentMailTimeoutError("Timeout exceeded when calling POST /v0/inboxes/{inbox_id}/drafts.");
                case "unknown":
                    throw new errors.AgentMailError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (_response.error.reason === "status-code") {
                switch (_response.error.statusCode) {
                    ...
                    case 403:
                        throw new AgentMail.MessageRejectedError(_response.error.body, _response.rawResponse);
                    default:
                        throw new errors.AgentMailError({
                            statusCode: _response.error.statusCode,
                            body: _response.error.body,
